...
import dlnu.o2oboot.dao.LocalAuthDao;
import dlnu.o2oboot.dto.LocalAuthExecution;
import dlnu.o2oboot.entity.LocalAuth;
import dlnu.o2oboot.enums.LocalAuthStateEnum;
import dlnu.o2oboot.exceptions.LocalAuthOperationException;
import dlnu.o2oboot.service.LocalAuthService;
import dlnu.o2oboot.util.MD5;
...
public class LocalAuthServiceImpl implements LocalAuthService {
	...
	public LocalAuthExecution bindLocalAuth(LocalAuth localAuth) throws LocalAuthOperationException {
		...
		if (localAuth == null || localAuth.getPassword() == null || localAuth.getUsername() == null
				|| localAuth.getPersonInfo() == null || localAuth.getPersonInfo().getPersonId() == null) {
			return new LocalAuthExecution(LocalAuthStateEnum.NULL_AUTH_INFO);
		}
		// 查询此用户是否已绑定过平台帐号
		LocalAuth tempAuth = localAuthDao.queryLocalByUserId(localAuth.getPersonInfo().getPersonId());
		if (tempAuth != null) {
